<template>
    <div class="flex flex-wrap -mx-3 mb-5">
        <div class="px-3 mb-6  mx-auto w-11/12 bg-white border rounded-xl">
            <div class="sm:flex items-stretch justify-between grow lg:mb-0  py-5 px-5">
                <div class="flex flex-col flex-wrap justify-center mb-5 mr-3 lg:mb-0">
                    <NuxtLink to="/" class="!font-medium !text-blue-gray-900 !transition-colors hover:!text-pink-500">
                        <span
                            class="flex select-none items-center gap-2 rounded-lg py-2 px-4 text-center align-middle font-sans text-x font-bold uppercase text-pink-500 transition-all hover:bg-pink-500/10 active:bg-pink-500/30 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
                            App Noticias
                        </span>
                    </NuxtLink>
                </div>
                <div class="flex flex-col flex-wrap justify-center mb-5 mr-3 lg:mb-0">
                    <NuxtLink to="/home"
                        ...
                        <button
                            ...
                            type="button" data-ripple-dark="true"> Home

                        </button>
                    </NuxtLink>
                </div>
                <div class="flex flex-col flex-wrap justify-center mb-5 mr-3 lg:mb-0" v-if="dataUser.hasOwnProperty('_id')">
                    <NuxtLink to="/dashboard"
                        class="!font-medium !text-blue-gray-900 !transition-colors hover:!text-pink-500">
                        <button
                            class="flex select-none items-center gap-2 rounded-lg py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-pink-500 transition-all hover:bg-pink-500/10 active:bg-pink-500/30 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                            type="button" data-ripple-dark="true"> Dashboard
                ...
                <div class="flex items-center lg:shrink-0 lg:flex-nowrap">
                    <div class="relative flex items-center lg:ml-4 sm:mr-0 mr-2">
                        ...
                        <span onclick="(() => { this.previousElementSibling.value=''})()"
                            class="absolute right-0 left-auto mr-4 leading-none -translate-y-1/2 peer-placeholder-shown:hidden top-1/2 hover:text-primary text-muted">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6">
